...
public class XxlJobApiConstant {
    ...
    public static final String START_URL = "/jobinfo/startJob";
    public static final String ADD_START_URL = "/jobinfo/addAndStart";
    public static final String GET_GROUP_ID = "/jobgroup/getGroupId";
}
